...
LFCM (Lotus File Cabinet Management) is a distributed attachment storage architecture with a dynamic allocation mechanism for Lotus Domino/Notes.

**Version :** 1.0.1

**Installation Overview :** <br>
**Step 1:**
Place the physical database template file (NTF) in
the data root directory of the Lotus Domino/Notes server.

**Step 2:** Deploy the File Cabinet Management (FCM)
system. After initialization, configure the following param-
eters:
...
**Step 3:** Copy the required components from the LFCM Template Application into the target application database
...
of the Lotus Domino/Notes platform.
